...
//!
//! The dump is the **full** serde serialization of [`rpt::model::Report`] — every field, including
//! defaults, and the whole subreport tree via [`rpt::model::Report::subreports`]. It is a mirror of
...
/// [`DecodeCoverage::warning`](rpt::DecodeCoverage::warning) when it is `Some`.
///
/// # Errors
///
...
pub fn run(input: &str, output: Option<&str>) -> Result<rpt::DecodeCoverage, Error> {
