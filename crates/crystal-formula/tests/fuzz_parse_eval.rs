...
use crystal_formula::eval::{vm, EmptyContext};
use crystal_formula::{parse, validate_str, Syntax, ValidationContext};
...
/// Inputs that have historically broken parsers, kept as a named corpus so a regression is legible
/// rather than hiding behind a seed.
#[test]
