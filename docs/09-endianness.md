...
out wildly wrong, flip and re-check. `rpt dump`'s scalar-probe grid prints every offset both ways at once, which is the
fastest way to settle it — see [Usage](11-usage.md).

---

← [Support matrix](08-support-matrix.md) · [Index](README.md) · **Next:** [The codebase](10-codebase.md) →
